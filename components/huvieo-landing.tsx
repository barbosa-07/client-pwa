  ...
  const features = [
    {
      ...
      description:
        "Our advanced AI analyzes thousands of career paths to find your perfect match",
    },
    {
      icon: Brain,
      title: "Intelligent Learning",
      description:
        "AI-driven personalized learning recommendations based on your career goals",
    },
    {
      icon: Target,
      title: "Smart Matching",
      description:
        "AI algorithm matches you with the most relevant job opportunities",
    },
  ];
  ...
  const whyChooseUs = [
    {
      ...
      description:
        "Our AI gives you the most accurate and personalized career advice based on data-driven insights.",
    },
    {
      icon: Users,
      title: "Expert Counseling",
      description:
        "Access to top career counselors and mentors for one-on-one sessions to guide you through complex career decisions.",
    },
    {
      icon: BarChart,
      title: "Affordable & Accessible",
      description:
        "A freemium model that ensures everyone, no matter their financial situation, gets the support they need.",
    },
    {
      icon: Building2,
      title: "Localized Recommendations",
      description:
        "Tailored career paths, resources, and job opportunities specific to the Indian market.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "AI career counseling uses machine learning algorithms to analyze your skills, interests, and the job market to recommend personalized career paths and development plans.",
    },
    {
      question: "How accurate are the career assessments?",
      answer:
        "Our AI models are trained on vast datasets and continuously updated to provide the most accurate recommendations based on real-time industry trends.",
    },
    {
      question: "Is there a mobile app for Huvieo?",
      answer:
        "Yes, Huvieo is mobile-friendly, and we are launching a dedicated app soon for easy access on the go.",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center md:text-left md:w-2/3">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Let our advanced AI analyze your potential and guide you to the
              perfect career path with personalized recommendations and
              real-time insights.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Experience the future of career guidance with our AI technology
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">
            Your AI Career Journey in 3 Steps
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                ...
                description:
                  "Our AI analyzes your personality, skills, and interests using advanced machine learning algorithms.",
              },
              {
                icon: Zap,
                title: "AI-Generated Roadmap",
                description:
                  "Receive a personalized career roadmap crafted by our AI based on millions of successful career paths.",
              },
              {
                icon: Trophy,
                title: "Smart Career Growth",
                description:
                  "AI continuously adapts your roadmap based on your progress and market trends.",
              },
            ].map((step, index) => (
              <div
                key={index}
          ...
          <div className="grid md:grid-cols-4 gap-12">
            <div>
              ...
              <p className="text-gray-400">
                India&apos;s most sophisticated AI-powered career counseling
                platform
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {[Facebook, Instagram, Linkedin, Twitter].map((Icon, index) => (
                  <div
                    key={index}
                    className="bg-gray-800 p-2 rounded-lg hover:bg-blue-600 transition-colors cursor-pointer"
                  >
